 ...
 * index is i) in the array A, you can jump to any one of the place in the
 * array A indexed i+1, i+2, …, i+B if this place can be jumped to. Also, if
 * you step on the index i, you have to pay Ai coins. If Ai is -1, it means you
 ...
 * Pbm, if and only if at the first i where Pai and Pbi differ, Pai < Pbi; when
 * no such i exists, then n < m.
