 ...
 * same as another if they have the same shape, or have the same shape after
 * rotation (90, 180, or 270 degrees only) or reflection (left/right direction
 ...
 * clockwise rotation on the first island, then two islands will have the same
 * shapes.
 * 
 * 
 * Example 2:
